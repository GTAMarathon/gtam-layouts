...
const gameNameMap = new Map<string, { gameShort: string, gameTwitch: string }>([
  ...
  ['Grand Theft Auto IV: The Lost and Damned', { gameShort: 'GTA The Lost and Damned', gameTwitch: 'Grand Theft Auto IV: The Lost and Damned' }],
  ...
  ['Grand Theft Auto: Long Night', { gameShort: 'GTA Long Night', gameTwitch: 'Grand Theft Auto: Vice City' }],
  ...
  ['Red Dead Redemption 2', { gameShort: 'Red Dead Redemption 2', gameTwitch: 'Red Dead Redemption 2' }],
